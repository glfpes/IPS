...
int main(int argc, char** argv)
{
	...
	string ImageFilename = CurrentDirectory + "\\..\\images\\history\\10.jpg";
	...
	SJTULab->Transmitters[1] = cv::Point3d(0.5, 0.5, 0);
	SJTULab->Transmitters[2] = cv::Point3d(0.5, -0.5, 0);
	SJTULab->Transmitters[3] = cv::Point3d(-0.5, -0.5, 0);
	SJTULab->Transmitters[4] = cv::Point3d(-0.5, 0.5, 0);
	SJTULab->Transmitters[5] = cv::Point3d(0, 0, 0);
